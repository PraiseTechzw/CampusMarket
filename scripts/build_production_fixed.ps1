...
if (Test-Path $aabPath) {
    ...
    Write-Host "  [OK] AAB: $aabPath" -ForegroundColor $Green
    Write-Host "    Size: $aabSizeMB MB ($aabSize bytes)" -ForegroundColor $Blue
} else {
    Write-Warning "  [X] No AAB found"
}
